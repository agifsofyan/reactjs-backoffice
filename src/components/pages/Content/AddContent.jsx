...
import { addContent, fetchContent } from '../../../actions/content';
...
const AddContent = ({ 
    ...
    React.useEffect(() => {
        ...
        let id = fullURL.split('/')[fullURL.split('/').length-1]
        id != 'add' && fetchContent(id);
    ...
    const onProductTypeChange = value => {
        ...
        console.log('[AddContent.onProductTypeChange]', productType);
    }
    ...
    const onProductVisibilityChange = value => {
        ...
        console.log('[AddContent.onProductVisibilityChange]', productVisibility);
    }
    ...
    const onProductSaleMethodChange = value => {
        ...
        console.log('[AddContent.onProductSaleMethodChange]', productSaleMethod);
    }

    const onHandleChangeForm = e => {
        setForm({ ...form, [e.target.name]: e.target.value });
        console.log('[AddContent.onHandleChangeForm]', form);
    }
...
export default connect(mapStateToProps, { fetchTopic, fetchAgent, addProduct, addContent, fetchContent})(AddContent);
